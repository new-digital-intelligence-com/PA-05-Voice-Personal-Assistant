...
export default function FaceStage({ videoRef, audioRef, status }: Props) {
  ...
  return (
    <div className="relative flex h-full w-full items-center justify-center">
      <div className="relative aspect-[2/3] h-full max-h-full overflow-hidden rounded-3xl border border-white/10 bg-black/40 shadow-[0_0_80px_rgba(79,70,229,0.18)]">
